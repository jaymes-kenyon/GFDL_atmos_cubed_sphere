...
!   <tr>
!     <td>fms_mod</td>
!     <td>write_version_number, check_nml_error</td>
!   </tr>
!   <tr>
!     <td>fms2_io_mod</td>
!     <td>file_exists, open_file, close_file, read_data, variable_exists,
...
!--- reset the tracers beyond condensate to a checkerboard pattern
    ...
    contains
      ...
      subroutine read_gfs_ic()
        ...
        if (data_source_fv3gfs) allocate (temp(is:ie,js:je,1:levp))
